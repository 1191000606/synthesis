...
if object_dataset == "objaverse":
    ...
    for prim in stage.Traverse():
        ...
        if f"/World/partnet_{object_id}/{link_name}_{object_id}/collisions" in prim_str and "mesh" in prim_str:
...
while True:
    # 这里采样数字大可以多探索一些面积小的区域，效果比调小采样数字多跑几次要好，重复跑+采样数字小的话就只关注面积大的区域了
    candidate_list = generate_antipodal_grasp_poses(point_cloud, normals, 500)
